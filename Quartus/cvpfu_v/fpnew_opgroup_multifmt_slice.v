module fpnew_opgroup_multifmt_slice_23084 (
	...
	generate
		if (OpGroup == 2'd1) begin : genblk1
			if ((DivSqrtSel == 2'd1) && !((FpFmtConfig[0] == 1) && (FpFmtConfig[1:4] == {4 {1'sb0}}))) begin : genblk1
				initial begin
					$display("Fatal [elaboration] C:\Users\jtori\OneDrive\Escritorio\cvfpu\fpnew_opgroup_multifmt_slice.sv:73:7 - fpnew_opgroup_multifmt_slice.genblk1.genblk1\n msg: ", "T-Head-based DivSqrt unit supported only in FP32-only configurations. Set DivSqrtSel = THMULTI or DivSqrtSel = PULP to use a multi-format divider");
					$finish(1);
				end
			end
			else if ((DivSqrtSel == 2'd2) && (FpFmtConfig[3] == 1'b1)) begin : genblk1
				initial $display("Warning [elaboration] C:\Users\jtori\OneDrive\Escritorio\cvfpu\fpnew_opgroup_multifmt_slice.sv:76:7 - fpnew_opgroup_multifmt_slice.genblk1.genblk1\n msg: ", "The DivSqrt unit of C910 (instantiated by DivSqrtSel = THMULTI) does not support FP8. Please use the PULP DivSqrt unit when in need of div/sqrt operations on FP8.");
			end
		end
	endgenerate
	...
	function automatic [31:0] fpnew_pkg_int_width;
		...
		case (ifmt)
			...
			default: begin
				$display("Fatal [%0t] C:\Users\jtori\OneDrive\Escritorio\cvfpu\fpnew_pkg.sv:96:9 - fpnew_opgroup_multifmt_slice.fpnew_pkg_int_width.<unnamed_block>\n msg: ", $time, "Invalid INT format supplied");
				$finish(1);
	...
	generate
		for (_gv_lane_2 = 0; _gv_lane_2 < sv2v_cast_32_signed(NUM_LANES); _gv_lane_2 = _gv_lane_2 + 1) begin : gen_num_lanes
			...
			if ((lane == 0) || (EnableVectors & !((OpGroup == 2'd1) && (lane >= NUM_DIVSQRT_LANES)))) begin : active_lane
				...
				assign lane_early_out_valid[lane] = 1'b0;
	...
	generate
		...
		if (OpGroup == 2'd3) begin : target_regs
			...
			genvar _gv_i_2;
			for (_gv_i_2 = 0; _gv_i_2 < NumPipeRegs; _gv_i_2 = _gv_i_2 + 1) begin : gen_bypass_pipeline
